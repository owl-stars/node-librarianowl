...
(function() {
  "use strict";
  var Documentation, Examples, Item, Librarianowl, Library, Util;
  ...
  Librarianowl = (function() {
    ...
    */
    ...
    Librarianowl.prototype.examples = function(source, target, options) {
      var comp,
        _this = this;
      if (options == null) {
        options = {};
  ...
  Examples = (function() {
    ...
    */
    ...
    Examples.prototype.source = null;
    ...
    */
    ...
    Examples.prototype.target = null;
    ...
    */
    ...
    Examples.prototype.options = null;
    ...
    */
    ...
    function Examples(source, target, options) {
      var defaults;
      this.source = source;
      this.target = target;
      defaults = {
    ...
    */
    ...
    Examples.prototype.compile = function(item, syntax) {
      var obj, stream, targetDir, targetFile, targetFilename;
      targetDir = path.resolve(this.target);
      targetFilename = this.options.filename ? this.options.filename.apply(this, [item, syntax]) : "examples." + syntax;
      targetFile = path.resolve(targetDir, targetFilename);
      if (fs.existsSync(targetFile)) {
        stream = fs.readFileSync(targetFile);
      } else {
        stream = this.options.imports ? this.options.imports.apply(this, [syntax]) : "";
      }
      fs.mkdirpSync(targetDir);
      obj = item.getContents();
